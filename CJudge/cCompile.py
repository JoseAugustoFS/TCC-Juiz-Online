...
def compile_c_file(file_path):
    try:
        ...
        output_file = os.path.splitext(file_path)[0]  # Remove a extensão ".c" para gerar o executável
        result = subprocess.run(['gcc', file_path, '-o', output_file], capture_output=True, text=True)
        
        if result.returncode == 0:
            print(f"Compilação bem-sucedida. Arquivo executável gerado: {output_file}.exe")
...
if __name__ == "__main__":
    ...
    c_file_path = r"C:\Users\Marcus\Documents\cCodes\exemple1.c"
